                    ...
                    <article>
                        ...
                        <!--Cards-->
                            <div id="SessaoCards" class="d-flex justify-content-between container-md p-4">
                                <!--Markplaces-->
                                    <div id="Cards" class="card bg-black d-flex justify-content-center align-items-center text-center w-25" style="">
