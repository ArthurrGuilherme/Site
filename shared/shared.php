                                ...
                                <div class="container-fluid">
                                    <!--Logo-->
                                        <a class="navbar-brand" href="./index.php">
                                            <img class="w-50 p-3" src="./img/LogoVendex.webp" alt="LogoPrincipal">
                                        </a>
                                    <!--Logo-->
                                    <!--Menu btn-->
...
<?php $headersecundario = '
    <!--Header Secundario-->
                <header class="HeaderSecundario">
                    <!--Estrutura-->
                        <nav style="padding: 0px !important;" class="navbar bg-light fixed-top">
                            <!--Logica do header-->
                                <div class="container-fluid container-md">
                                    <!--Logo-->
                                        <a class="navbar-brand" href="./index.php">
                                            <img id="LogoSecundario" class="w-75 p-2" src="./img/logovendexheader.webp" alt="LogoPrincipal">
                                        </a>
                                    <!--Logo-->
                                    <!--Menu btn-->
                                        <button class="navbar-toggler " type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar" aria-label="Toggle navigation">
                                            <svg style="color: var(--rosa-vendex);" id="BtnHeaderSecundario" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-list" viewBox="0 0 16 16">
                                                <path fill-rule="evenodd" d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5m0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5"/>
                                            </svg>
                                        </button>
                                    <!--Menu btn-->
                        ...
                        <div>
                            <span class="d-flex flex-column align-items-center justify-content-center">
                                ...
                                <ul id="IconsHeader" class="d-flex flex-row">
                                    ...
                                    <li>
                                        <svg id="icons03" xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" style="fill: #fc6aed;transform: ;msFilter:;"><path d="M21.593 7.203a2.506 2.506 0 0 0-1.762-1.766C18.265 5.007 12 5 12 5s-6.264-.007-7.831.404a2.56 2.56 0 0 0-1.766 1.778c-.413 1.566-.417 4.814-.417 4.814s-.004 3.264.406 4.814c.23.857.905 1.534 1.763 1.765 1.582.43 7.83.437 7.83.437s6.265.007 7.831-.403a2.515 2.515 0 0 0 1.767-1.763c.414-1.565.417-4.812.417-4.812s.02-3.265-.407-4.831zM9.996 15.005l.005-6 5.207 3.005-5.212 2.995z"></path></svg>
                                    </li>
                                </ul>
                            </span>
                        </div>
